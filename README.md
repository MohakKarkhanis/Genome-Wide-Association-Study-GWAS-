...
**Results**
For 2266 Rice Varieties, the Total Genotyping Rate is **0.981439**** with **871802** variants and **3001** people pass filters and QC where the most significants SNPs were exported into [significant_snps_awpr_repro.csv](significant_snps_awpr_repro.csv).
