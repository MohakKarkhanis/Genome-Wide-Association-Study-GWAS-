...
4. Capturing Genetic Variation: Performed PCA on the remaining 3001 samples to capture the genetic variations. The resulting eigenvectors (PC1 to PC5) `-see folder ` were extracted using Python to serve as covariates in the final Mixed Linear model.
5. 
